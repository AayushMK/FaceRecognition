...
def detect_faces(img, detector, face_landmark):
    ...
    if len(faces) > 0:
        for i, x in enumerate(faces):
            ...
            landmarks = face_landmark(gray_img, x)
...
if __name__ == '__main__':
    ...
    face_landmark = dlib.shape_predictor("../data/shape_predictor_68_face_landmarks.dat")
    ...
    while True:
        ...
        f = detect_faces(my_frame, detector, face_landmark)
